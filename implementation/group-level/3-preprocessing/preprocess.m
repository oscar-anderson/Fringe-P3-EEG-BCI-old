function preprocessedDataset = preprocess(dataset, baselineWindow, bpFreq, bsFreq, refChannel, threshold)
...
% Description:
    ...
    % Input:
        ...
        % threshold = array containing min and max amplitude to permit in data (mV)
